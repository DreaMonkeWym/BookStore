...
import com.wym.model.AdminExample.Criteria;
import com.wym.model.AdminExample.Criterion;
...
public class AdminSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAdminname() != null) {
            sql.SET("adminname = #{record.adminname,jdbcType=VARCHAR}");
        }
        
        if (record.getAdminpassword() != null) {
            sql.SET("adminpassword = #{record.adminpassword,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Admin record) {
        ...
        sql.WHERE("adminname = #{adminname,jdbcType=VARCHAR}");
