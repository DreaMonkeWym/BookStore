...
import com.wym.model.CommentExample.Criteria;
import com.wym.model.CommentExample.Criterion;
...
public class CommentSqlProvider {
    ...
    public String insertSelective(Comment record) {
        ...
        if (record.getCommentid() != null) {
            sql.VALUES("commentid", "#{commentid,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCommentid() != null) {
            sql.SET("commentid = #{record.commentid,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Comment record) {
        ...
        sql.WHERE("commentid = #{commentid,jdbcType=VARCHAR}");
