...
import com.wym.model.UserExample.Criteria;
import com.wym.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getFavor() != null) {
            sql.VALUES("favor", "#{favor,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getFavor() != null) {
            sql.SET("favor = #{record.favor,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getFavor() != null) {
            sql.SET("favor = #{favor,jdbcType=VARCHAR}");
        }
